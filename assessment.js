...
var me = {firstname:"Aaron", age:26, state:"Texas"};// CODE HERE
...
message['text'] = "never forget the code.";// CODE HERE
...
var myFriends = ["Sarin", "Jae", "Brad", "Natalie"];// CODE HERE

// // #6 Add a fifth friends name to the end of your myFriends array

myFriends.push("John");// CODE HERE

// // #7 Create a 'myArrayCopy' variable. It should equal the myArray variable. Use the built in JavaScript method to create a copy.
// //DON'T TOUCH THE CODE BELOW
var myArray = [1, 2, 3, 4];
// //DON'T TOUCH THE CODE ABOVE
var myArrayCopy = myArray.slice();// CODE HERE look at
...
var indexes = [];
function indexFinder(anArray, newArray){
  for(i=0; i<anArray.length; i++){
    newArray.push(i);
  };
  return newArray;
};
indexFinder(randomNumbers, indexes);